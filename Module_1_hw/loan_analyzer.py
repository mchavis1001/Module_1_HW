...
output = sum(loan_costs) / len(loan_costs)
print(output)
...
def pv(future_value, remaining_months, annual_discount_rate):
    output = future_value / (1 + annual_discount_rate/12) * remaining_months
...
present_value = pv(future_value, remaining_months, 0.2)
...
with open(output_path, 'w') as loan_file:
    writer = csv.writer(loan_file)
